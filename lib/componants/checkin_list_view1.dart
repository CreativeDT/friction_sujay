...
class CheckinListView1 extends StatelessWidget {
  const CheckinListView1({super.key});
              ...
              dense: true,
                ...
                leading: Container(
                  ...
                  child: Stack(
                    ...
                    children: [
                      Image.asset('assets/icons/menu/Ellipse1.png', scale:0.1,),

                      Column(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Image.asset('assets/icons/menu/maple.png',),
                          Text('MN',
